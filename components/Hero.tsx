...
<pointsMaterial size={0.05} color="#00BCD4" transparent opacity={0.6} sizeAttenuation />
</points>
);
};
...
<pointLight position={[0, 0, 5]} color="#4DD0E1" intensity={0.3} distance={50} />
</>
);
};
...
return (
<section ref={sectionRef} id="home" className="relative h-screen flex items-center justify-center overflow-hidden bg-black" >
